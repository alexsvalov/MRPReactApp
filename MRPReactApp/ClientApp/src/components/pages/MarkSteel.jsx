    ...
    return (
        <div>
            <Container>
                <Row>
                    <Col>
                        <input type="text" className="form-control" placeholder="Введите марку стали"
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="Введите марку стали"
